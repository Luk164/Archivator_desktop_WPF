...
var filename = "Archivator_desktop_WPF_WTS.exe";	        // The name of the executable to launch
...
try
{
	...
	// Modify the Control_Next of BodyTextRemove control to point to the new CheckBox
	...
	sql = "INSERT INTO `Control` (`Dialog_`, `Control`, `Type`, `X`, `Y`, `Width`, `Height`, `Attributes`, `Property`, `Text`, `Control_Next`, `Help`) VALUES ('FinishedForm', 'CheckboxLaunch', 'CheckBox', '18', '117', '343', '12', '3', 'LAUNCHAPP', '{\\VSI_MS_Sans_Serif13.0_0_0}" + checkboxText + "', 'UpdateText', '|')";
	view = database.OpenView(sql);
	view.Execute();
	view.Close();
